...
void front()
{
	...
	bitmap_output(200, 750, "GSSS COLLEGE OF ENGINEERING AND TECHNOLOGY FOR WOMEN",GLUT_BITMAP_TIMES_ROMAN_24);

		glVertex2f(295, 560);
		glVertex2f(395, 560);
	glEnd();
	bitmap_output(225, 700, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING",GLUT_BITMAP_TIMES_ROMAN_24);

		glVertex2f(325, 521);
		glVertex2f(360, 521);
	glEnd();

	bitmap_output(200, 600, "DYNAMIC SORTING ALGORITHM VISUALIZER USING OPENGL",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(50, 400, "LISHA M (4GW17CS033)",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(450, 400, "NISHA S (4GW17CS054)",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(50, 300, "UNDER THE GUIDANCE OF",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(50, 260, "VISHWESH J",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(50, 220, "Asst. prof. Dept of CSE, GSSSIETW",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(450, 300, "UNDER THE GUIDANCE OF",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(450, 260, "USHA RANI J",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	glColor3f(0.0,0.0,1.0);
	bitmap_output(450, 220, "Asst. prof. Dept of CSE, GSSSIETW",GLUT_BITMAP_TIMES_ROMAN_24);
